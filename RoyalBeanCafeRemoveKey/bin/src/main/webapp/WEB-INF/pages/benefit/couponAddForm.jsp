            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">AddCoupon</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-12 mb-3">
                    <div class="checkout-address">
                        ...
                        <form:form class="needs-validation" action="addCp" modelAttribute="benefit/couponAddForm" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                	<form:label path="cpsline">Coupon start date*</form:label>
                                	<form:input class="form-control" path="cpsline"></form:input>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <form:label path="cpdline">Coupon end date *</form:label>
                                	<form:input class="form-control" path="cpdline"></form:input>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <form:label path="shoptype">Coupon shop type *</form:label>
                                	<form:input class="form-control" path="shoptype"></form:input>
                                </div>
                                <div class="col-md-6 mb-3">

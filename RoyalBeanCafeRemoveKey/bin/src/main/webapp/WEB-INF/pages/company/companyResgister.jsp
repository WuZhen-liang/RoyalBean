			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2>廠商註冊</h2>
						<ul class="breadcrumb">
							<li class="breadcrumb-item active">請輸入您的名稱，我方將提供您id，以便您未來登入</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<form class="needs-validation" method="post">
								<div class="row">
									<div class="col-md-12 mb-3">
										...
										<input type="text" name="companyName" id="companyName" size="45" class="form-control" placeholder="請輸入廠商名稱" autocapitalize="off"
											required>
										 <span>${errors.name}</span><br>
										 <label for="firstName">統一編號</label>
										<input type="text" name="companyNumber" id="companyNumber" size="45" class="form-control" placeholder="請輸入廠商統一編號" autocapitalize="off"
											required>
										 <span>${errors.name}</span><br>
										 <label for="firstName">密碼</label>
										<input type="password" name="pwd" id="pwd" size="45" placeholder="使用者密碼" autocapitalize="off"
										class="form-control" required>
										 <span>${errors.pwd}</span><br>
									</div>
									<div class="col-md-12 mb-3" style="text-align: center;">
										<input type="submit" value="送出" id="sendcompany" class="ml-auto btn hvr-hover" style="color: white; border: none; border-radius: 5px;">
										<input type="reset" value="清除" class="ml-auto btn hvr-hover" style="color: white; border: none;  border-radius: 5px;">
									</div>
								</div>
								<hr class="mb-1">
							</form>

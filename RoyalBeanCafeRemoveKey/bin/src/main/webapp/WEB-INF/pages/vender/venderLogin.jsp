            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>Hello :- <a href="#">廠商編號</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
                            <li><a href="CompanyResgiter">廠商註冊</a></li>
                            <li><a href="LoginCompany">廠商登入</a></li>
                            <li><a href="Logout">廠商登出</a></li>
                            <li><a href="#">聯絡我們</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="coupon.controller">查看優惠券</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">

...
<head>
    ...
    <!-- Site Metas -->
    <title>ActivityStoreManagement</title>
   ...
   <!-- Start Main Top -->
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="activityStore">門市管理</a></li>
    ...
    <div class="latest-blog">
        <div class="container">
            ...
            <table id="aStoreList" class="table table-hover">
				  <!--
				  <thead>
				    <tr>
    ...
    <script type="text/javascript">
		...
		function load(indexPage){
			$.ajax({
			   type:'post',
			   url:'/activityStorefindbypage/' + indexPage,
					       ...
					       if(json=null){
					         ...
					         $.each(parsedObjinArray,function(i,n){
					            var tr = "<tbody><tr>" + 
					                     ...
					                     "<td>" + n.sName + "</td>" + 
					                     "<td>" + n.editDate + "</td>" +
					                     "<td><a href=" + ${companyID} + n.sId + "><button type='button' class='btn btn-light'><i class='fa fa-pencil-square-o'/></button></a></td>" + 

...
<body>
		...
		<div class="container" style="font-size:16.5px">
			...
			<div>
		    	...
		    	<form id="activiyPhotoForm">
					...
					<hr class="mb-4">
					<div class="title">
					<span><h3 style="color: #8B4513">Step2. 填寫活動基本資料  <button id="activityinsertval" class="btn btn-outline-warning">一鍵輸入</button></h3></span>
					</div>
					<hr class="mb-4">
					
				<form:form class="needs-validation" action="addActivity" modelAttribute="activity/activityAdd">
					<form:input type="hidden" class="form-control" path="company" value="${activity.company}"/>
					<form:input type="hidden" class="form-control" path="activityStore" value="${activity.activityStore}"/>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input class="form-control" path="aName" id="aName"/>
							<div class="invalid-feedback">Valid first name is required.</div>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="aCategory">活動性質 *</form:label>
							<form:select class="form-control" path="aCategory" id="aCategory">
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:select class="form-control" path="aTarget" id="aTarget">
								<form:option value="尚未選擇" label="Please Select..."/>
						...
						<div class="col-md-6 mb-3">
							...
							<form:input class="form-control" path="aPeople" id="aPeople"/>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input class="form-control" path="aPrice" id="aPrice"/>
							<div class="invalid-feedback">Valid first name is required.</div>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="aTime">活動時間(單位分鐘) *</form:label>
							<form:input class="form-control" path="aTime" id="aTime"/>
							<div class="invalid-feedback">Valid last name is required.</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:textarea class="form-control" path="aContent" rows="5" id="aContent"/>
						</div>
					</div>
	...
	//一鍵輸入
	$('#activityinsertval').click(function () {
		$('#aName').val("SCA國際咖啡證照課程");
		$('#aCategory').val("職人課程");
		$('#aTarget').val("創業職人");
		$('#aPeople').val("10");
		$('#aPrice').val("2500");
		$('#aTime').val("180");
		$('#aContent').val("透過國際專業的研究理論，將學習咖啡方法系統化，有助於減少進入咖啡領域摸索時間。適用於個人學習、團隊教育訓練，甚至延伸到咖啡設備商、咖啡器材商、咖啡生豆商、台灣咖啡農民、咖啡相關行銷單位都可以適用的解決方案。");

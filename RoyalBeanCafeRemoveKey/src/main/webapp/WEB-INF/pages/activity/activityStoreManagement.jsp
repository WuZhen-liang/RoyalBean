    ...
    <div class="latest-blog">
        <div class="container" style="font-size:16.5px">
            ...
            <ul id="storetitle" class="nav nav-tabs">
			  <li class="nav-item">
			    <a class="nav-link active" aria-current="page" href="activityStore">門市總表</a>
			  </li>
			  <li class="nav-item">
            ...
            <table id="aStoreList" class="display">
				  ...
				  <thead>
				    <tr>
				      ...
				      <th scope="col">門市編輯</th>
				      <th scope="col">門市刪除</th>
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td><a href="storeupdate${actstores.sId}"><button type='button' class='btn btn-outline-warning'><i class='fa fa-pencil-square-o'/></button></a></td>
				      ...
				      <td><a href="activityadd${actstores.sId}"><button type='button' class='btn btn-outline-info'><i class="fas fa-calendar-alt"/></button></a></td>

...
<body>
		...
		<div class="container" style="font-size:16.5px">
			...
			<ul class="nav nav-tabs">
				...
				<li class="nav-item"><a class="nav-link  active"
					aria-current="page" href="activityStoreAdd">新增門市</a></li>
			</ul>


			<div>
				<hr class="mb-4">
					<div class="title"><span><h3 style="color: #8B4513">Step1. 新增門市照片</h3></span></div>
				<hr class="mb-4">
				
		    	<form id="storePhotoForm">
		    		<figure class="figure">
					  <img src="/images/imageSample.jpg" id="show" class="figure-img img-fluid rounded" width="400px">
					...
					<hr class="mb-4">
					<div class="title">
					<span><h3 style="color: #8B4513">Step2. 填寫門市基本資料  <button id="storeinsertval" class="btn btn-outline-warning">一鍵輸入</button></h3></span>
					</div>
					<hr class="mb-4">
					<div class="row">
						<div class="col-md-6 mb-3">
						<form:form class="needs-validation" action="addStores" modelAttribute="activity/activityStoreAdd">
							...
							<form:input class="form-control" path="sName" id="sName"/>
							<div class="invalid-feedback">Valid first name is required.</div>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="sPhone">門市電話 *</form:label>
							<form:input class="form-control" path="sPhone" id="sPhone"/>
					...
					<div class="mb-3">
						...
						<form:input class="form-control" path="sAdd" id="sAdd"/>
						<div class="invalid-feedback">Please enter your shipping address.</div>
					</div>
					<div class="row">
						<div class="col-md-6 mb-3">
							<form:label path="sNs">經度 *</form:label>
							<form:input class="form-control" path="sNs" id="sNs"/>
							<div class="invalid-feedback">Valid first name is required.</div>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="sEw">緯度 *</form:label>
							<form:input class="form-control" path="sEw" id="sEw"/>
							<div class="invalid-feedback">Valid last name is required.</div>
						</div>
					</div>
					<div class="mb-3">
					...
					<hr class="mb-4">
					<div class="title"><span><h3 style="color: #8B4513">Step3. 門市營業時間</h3></span></div>
					<hr class="mb-4">
					<h4 style="color: #8B4513">星期一</h4>
					<div class="row">
						<div class="col-md-6 mb-3">
							<form:label path="monOpen">開店時間</form:label>
							<form:input type="Time" class="form-control" path="monOpen" id="monOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="monClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="monClose" id="monClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="tueOpen" id="tueOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="tueClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="tueClose" id="tueClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="wedOpen" id="wedOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="wedClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="wedClose" id="wedClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="thuOpen" id="thuOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="thuClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="thuClose" id="thuClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="firOpen" id="firOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="firClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="firClose" id="firClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="satOpen" id="satOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="satClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="satClose" id="satClose"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input type="Time" class="form-control" path="sunOpen" id="sunOpen"/>
						</div>
						<div class="col-md-6 mb-3">
							<form:label path="sunClose">關店時間</form:label>
							<form:input type="Time" class="form-control" path="sunClose" id="sunClose"/>
						</div>
					</div>
	...
	//一鍵輸入
	$('#storeinsertval').click(function () {
		$('#sName').val("HWC黑沃咖啡-台北復興");
		$('#sPhone').val("02-7711-6577");
		$('#sAdd').val("復興南路一段122巷4號1樓");
		$('#sNs').val("121.542944");
		$('#sEw').val("25.04391");
		$('#monOpen').val("10:00");
		$('#monClose').val("22:00");

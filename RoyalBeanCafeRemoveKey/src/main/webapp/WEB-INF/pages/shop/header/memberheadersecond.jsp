                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="font-size:20px">
                                <li><a class="shoppd" href="usershopSearchAll">商品總覽</a></li>
                                <li><a class="shoppd" href="userOrderSearch">訂單紀錄</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="font-size:20px">
                                <li><a href="${memberID}/indexArticle">文章分享</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="font-size:20px;text-align: center;border-radius: 10px;">
                                ...
                                <a href="member_center_${memberID}"><i class="far fa-address-book"></i> 會員中心</li></a>                              
                                <hr> 
                                <a href="/user/logout" class="logout"><li style="margin: 20px;"><i class="fas fa-sign-out-alt"></i> 登出</li></a>
                            </ul>
                        </li>
                    </ul>
                </div>

        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <li><a href="member_resgiter">會員註冊</a></li>
                            <li><a href="user/login">會員登入</a></li>
                            <li><a href="company_resgiter">廠商註冊</a></li>
                            <li><a href="company/login">廠商登入</a></li>
                            <li><a href="staff_resgiter">管理員註冊</a></li>
                            <li><a href="admin/login">管理員登入</a></li>
                            <li></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="find${memberID}/usershopSearchAll">所有商品</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="${memberID}/activity">活動資訊</a></li>
                                <li><a href="${memberID}/store">門市據點</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="cart.html">優惠券</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">Service</a>
                            <ul class="dropdown-menu">
                                <li><a href="${companyID}/indexArticle">文章分享</a></li>
                                <li><a href="checkout.html">Q&A</a></li>
                                <li><a href="${memberID}/AddReportEntry">問題回報</a></li>
                            </ul>
                        </li>

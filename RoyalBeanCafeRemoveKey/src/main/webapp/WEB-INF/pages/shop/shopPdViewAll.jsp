...
<!--             		<span class="main-color-text my-cart-total"></span> -->
            		    <li class="total">
                            <a href="shoppaypage" class="btn btn-default hvr-hover btn-cart">check out</a>
                            <span class="lighter-text" style="color: brown">Total:</span>
                            <span class="main-color-text my-cart-total" style="color: red;"></span>
<!--                             <span class="float-right my-cart-total"><strong>Total:</strong>0</span> -->
                        </li>
          			</div>
        		</div>
            </div> 
                		...
                		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    <img src="/images/shop/${shopSearchResult.shopPdPicture}" class="img-fluid" alt="Image">
                                    <div class="mask-icon">
                                        <ul>
                                ...
                                <div class="why-text">									                                
                                    <h4 name="pdname" id="${shopSearchResult.shopPdName}" class="my-cart-name product my-cart-id">${shopSearchResult.shopPdName}</h4>
                                    <span><strong>$</strong></span><span name="pdprice" class="price my-cart-price">${shopSearchResult.shopPdPrice}</span>
                                </div>
                            </div>
                		</div>
                	</c:forEach>

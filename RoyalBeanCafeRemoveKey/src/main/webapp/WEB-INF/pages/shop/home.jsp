        ...
        <div class="container">
            <form method="post"  action="/pay">
                <div class="col-50">
                    ...
                    <input type="text" id="price1" name="price" value="" disabled="disabled">
...
<!--                     <input type="text" id="currency" name="currency" placeholder="Enter Currency"> -->
    ...
    <div class="col-25">
        <div class="container">
            <h4>Cart <span class="cart" style="color:black"><i class="fa fa-shopping-cart"></i></span></h4>
            <div class="shopcaritem"></div>
            <hr>
            <p>Total <span class="totalprice" style="color:black"></span></p>
        </div>
    </div>
</div>

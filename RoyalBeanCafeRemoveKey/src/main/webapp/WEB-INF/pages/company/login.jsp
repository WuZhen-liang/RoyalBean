...
<main class="form-signin">
  <form action="/company/login" method="post">
    ...
    <h1 class="h3 mb-3 fw-normal">廠商登入</h1>
	<h2 class="h3 mb-3 fw-normal" style="font-size: 12px;color: brown;"> ${error}</h2>
    <div class="form-floating">
      <input type="text" class="form-control" id="NameInput" placeholder="number" name="username">
  ...
  <br>
    ...
    <div>
        ...
        <input type="button" value="一鍵輸入2" class="w-30 btn btn-lg btn-primary normalstyle" id="twobutton">
...
<script>
 $('#onebutton').click(function(){
   $('#NameInput').val('16097091');
   $('#PasswordInpunt').val('test123456');
 });
 $('#twobutton').click(function(){
   $('#NameInput').val('53397851');
   $('#PasswordInpunt').val('53397851');
 });
</script>
</html>

						...
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<h2>廠商註冊</h2>
									<ul class="breadcrumb">
										<li class="breadcrumb-item active">請輸入您的名稱，我方將提供您id</li>
									</ul>
								</div>
							</div>
						</div>
										...
										<form class="needs-validation" method="post">
											<div class="row">
												<div class="col-md-12 mb-3">
													<label for="firstName" style="font-size: 20px;">廠商姓名</label>
													<input type="text" name="companyName" id="companyName" size="45"
														class="form-control newinputstyle" placeholder="請輸入廠商名稱" autocapitalize="off"
														required>
													<span>${errors.name}</span><br>
													<label for="firstName" style="font-size: 20px;">統一編號</label>
													<input type="text" name="companyNumber" id="companyNumber" size="45"
														class="form-control" newinputstyle placeholder="請輸入廠商統一編號"
												...
												<div class="col-md-12 mb-3" style="text-align: center;">
													<input type="submit" value="送出" id="sendcompany"

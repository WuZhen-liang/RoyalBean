        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size:18px">新增QA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="submit" id="send" value="確認新增" class="btn btn-success float-right">
          <!-- /.card -->        
        </div> 
        </div>
        </section>
...
$('#onclickinput').click(function () {
	$('#QAtitle').val("商品缺貨的話何時會補貨");
	$('#QAanswer').val("大多數售完商品，幾乎都是因為生豆商缺貨；極少部分是生豆量較稀少基於上述兩種原因，暫時不確定商品何時會再次上架，請您見諒~！");
;
